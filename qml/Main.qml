...
MainView {
	...
	Page {
		...
		Flickable {
			...
			property var isinstalled: Template.execbool("sh /opt/click.ubuntu.com/ontheroad.emanuelesorce/current/scripts/isinstalled.sh")
			property var isupdated: Template.execbool("sh /opt/click.ubuntu.com/ontheroad.emanuelesorce/current/scripts/isupdated.sh")
